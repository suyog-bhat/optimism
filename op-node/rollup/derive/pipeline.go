...
func NewDerivationPipeline(log log.Logger, rollupCfg *rollup.Config, daConfig rollup.DAConfig, l1Fetcher L1Fetcher, l1Blobs L1BlobsFetcher, l2Source L2Source, engine LocalEngineControl, metrics Metrics, syncCfg *sync.Config) *DerivationPipeline {

	// Pull stages
	l1Traversal := NewL1Traversal(log, rollupCfg, l1Fetcher)
	dataSrc := NewDataSourceFactory(log, rollupCfg, daConfig, l1Fetcher, l1Blobs) // auxiliary stage for L1Retrieval
