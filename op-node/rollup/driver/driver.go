...
func NewDriver(driverCfg *Config, cfg *rollup.Config, daConfig rollup.DAConfig, l2 L2Chain, l1 L1Chain, l1Blobs derive.L1BlobsFetcher, altSync AltSync, network Network, log log.Logger, snapshotLog log.Logger, metrics Metrics, sequencerStateListener SequencerStateListener, syncCfg *sync.Config) *Driver {
	...
	derivationPipeline := derive.NewDerivationPipeline(log, cfg, daConfig, verifConfDepth, l1Blobs, l2, engine, metrics, syncCfg)
